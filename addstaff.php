        ...
        <form action="add_staff.php" method="POST">
             <table align='center'>
                ...
                <tr>
                    <td>Gender</td>
                    <td>
                        Male<input type="radio" name="staff_gender" value="M" checked/>
                        Female<input type="radio" name="staff_gender" value="F" />
						Other<input type="radio" name="staff_gender" value="O"/>
                    </td>
                </tr>
                <tr>
                    <td>
