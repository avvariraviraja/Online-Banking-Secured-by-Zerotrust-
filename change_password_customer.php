...
<html>
   ...
   text-align: center;
    ...
    <br><br><br><br>
    <h3 style="text-align:center;color:#ffd800;"><u>Change Password</u></h3>
            <form action="" method="POST">
                <table align="center">
                    <tr>
                        <td style="color:#dff6f0">Enter Old Password:</td>
                        <td><input type="password" name="old_password" required=""/></td>
                    </tr>
                    <tr>
                        <td style="color:#dff6f0">Enter New Password:</td>
                        <td><input type="password" name="new_password" required=""/></td>
                    </tr>
                    <tr>
                        <td style="color:#dff6f0">Enter Password Again:</td>
