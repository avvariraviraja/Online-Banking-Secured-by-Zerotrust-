...
?>
            ...
            <div class="content2">
            <p style="color:#dff6f0;"><span class="heading">Balance: ₹ </span><?php echo $balance;?></p>
            <p style="color:#dff6f0;"><span class="heading">Account status: </span><?php echo $acc_status;?></p>
            <p style="color:#dff6f0;"><span class="heading">Last Login: </span><?php echo $last_login;?></p>
           </div>
