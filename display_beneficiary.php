...
?>
     <br><br><br>
        <h3 style="text-align:center;color:#ffd800;"><u>Added Beneficiary</u></h3>
    <form action="delete_beneficiary.php">
<table align="center">
                        
                        <th style="color:#dff6f0">Id</th>
                        <th style="color:#dff6f0">Name</th>
                        <th style="color:#dff6f0">Beneficiary Account No</th>
                        <th style="color:#dff6f0">status</th>
