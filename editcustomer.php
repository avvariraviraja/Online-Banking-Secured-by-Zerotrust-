    ...
    <?php include 'admin_navbar.php'?>
            ...
            <table align="center">
                ...
                <tr>
                    <td>Gender</td>
                    <td>
                        Male<input type="radio" name="edit_gender" value="M" <?php if($rws[2]=="M") echo "checked";?>/>
                        Female<input type="radio" name="edit_gender" value="F" <?php if($rws[2]=="F") echo "checked";?>/>
						Other<input type="radio" name="edit_gender" value="O" <?php if($rws[2]=="O") echo "checked";?>/>
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <select name="edit_account">
							...
							<option <?php if($rws[5]=="recurring") echo "selected";?>>Recurring</option>
                        </select>
                    </td>
                </tr>
