    ...
    <?php include 'admin_navbar.php'?>
            ...
            <table align="center" >
                ...
                <tr>
                    <td>Gender</td>
                    <td>
                        Male<input type="radio" name="edit_gender" value="M" <?php if($rws[10]=="M") echo "checked";?>/>
                        Female<input type="radio" name="edit_gender" value="F" <?php if($rws[10]=="F") echo "checked";?>/>
						Other<input type="radio" name="edit_gender" value="O" <?php if($rws[10]=="O") echo "checked";?>/>
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <select name="edit_status">
                            ...
                            <option <?php if($rws[3]=="divorced") echo "selected";?>>ivorced</option>
                        </select>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <select name="edit_dept">
                            <option <?php if($rws[4]=="revenue") echo "selected";?>>Accounts</option>
