<!-- Authors:
     Avvari Raviraja, Lovely Professional University.
	 Vamshi Varma   , Lovely Professional University.
	 Akkala Dinesh  , Lovely Professional University.
...
<html>
    ...
    <body>
        ...
        <div class="header">
            <img src="top.jpg" height="100%" width="100%" style="border-radius:8px"/>
            </div>
            <div class="navbar">
            <ul>
        ...
        <div class="image">
            <img src="https://erticonetwork.com/wp-content/uploads/2018/04/2018_cybersecurity_hacking-1280x640.png" height="100%" width="100%"/>
            <div class="text">
    ...
    <a href="faq.php"><h3>FAQ'S</h3></a>
            ...
            <div class="left_panel">
                <p style="color:#dff6f0">Our internet banking portal provides personal banking services that gives you complete control over all your banking demands online.</p>
                <h3 style="color:#ffd800">Features</h3>
                <ul>
            ...
            <div class="right_panel">
                    ...
                    <h3 style="color:#ffd800">PERSONAL BANKING</h3>
                    <ul>
